    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        />
                        <h1 className="text-2xl font-bold text-gray-900">Eklavya Foundation</h1>
                    </div>
                    <nav className="hidden md:flex space-x-10">
                        <button
                            onClick={() => setActiveTab("about")}
                            className={`text-base font-medium ${activeTab === "about" ? "text-blue-600" : "text-gray-500 hover:text-gray-900"}`}
                        >
                            About Us
                        </button>
                        <button
                            onClick={() => setActiveTab("programs")}
                            className={`text-base font-medium ${activeTab === "programs" ? "text-blue-600" : "text-gray-500 hover:text-gray-900"}`}
                        >
                            Our Programs
                        </button>
                        <button
                            onClick={() => setActiveTab("donate")}
                            className={`text-base font-medium ${activeTab === "donate" ? "text-blue-600" : "text-gray-500 hover:text-gray-900"}`}
                        >
                            Donate
                        </button>
                        <button
                            onClick={() => setActiveTab("contact")}
                            className={`text-base font-medium ${activeTab === "contact" ? "text-blue-600" : "text-gray-500 hover:text-gray-900"}`}
                        >
                            Contact
                        </button>
                    </nav>
                    <div>
                        <Button variant="outline" onClick={() => navigate('./login')} className="mr-2">Login</Button>
                        <Button onClick={() => setActiveTab("login")}>Join Us</Button>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                {activeTab === "about" && (
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-8">About Eklavya Foundation</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div>
                                ...
                                <ul className="list-disc pl-5 space-y-2 text-lg text-gray-700 mb-6">
                                    <li>Developing curricular materials for all levels of schooling and propagating their use</li>
                                    <li>Improving the all-round functioning of schools</li>
                                    <li>Motivating and training teachers to become more innovative in their educational practices and encouraging them to apply teaching methodologies that Eklavya has evolved and field tested</li>
                                    <li>Working closer with communities to develop need-related educational programmes and activities</li>
                                    <li>Developing and publishing teaching-learning and other educational/literary materials</li>
                                </ul>
                                <p className="text-lg text-gray-700 mb-6">
                            ...
                            <div className="bg-gray-100 rounded-lg h-60 overflow-hidden">
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-o7JmMLlVpnVAOrG6fB-9Zo-Y5NsvIVpiAA&s"
                ...
                {activeTab === "donate" && (
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-8">Support Our Cause</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div>
                                <p className="text-lg text-gray-700 mb-6">
                                ...
                                <div className="flex flex-col space-y-4">
                                    ...
                                    <Button variant="outline" size="lg">Become a Monthly Supporter</Button>
                                </div>
                            </div>
                            <Card>
                                <CardHeader>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            <div>
                                ...
                                <p className="mb-4">contact@eklavyafoundation.org</p>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <Input id="register-email" type="email" placeholder="your.email@example.com" />
                                        </div>
                                        <div>
                ...
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-300">Empowering communities through education since 2001.</p>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Quick Links</h3>
                            <ul className="space-y-2">
                                <li><button onClick={() => setActiveTab("about")} className="text-gray-300 hover:text-white">About Us</button></li>
                                <li><button onClick={() => setActiveTab("programs")} className="text-gray-300 hover:text-white">Our Programs</button></li>
                                <li><button onClick={() => setActiveTab("donate")} className="text-gray-300 hover:text-white">Donate</button></li>
                                <li><button onClick={() => setActiveTab("contact")} className="text-gray-300 hover:text-white">Contact</button></li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <form className="flex gap-2">
                                <Input placeholder="Your email" className="bg-gray-700 border-gray-600 text-white placeholder-gray-400" />
                                <Button>Subscribe</Button>
                            </form>
                        </div>
                    </div>
                    <div className="mt-12 border-t border-gray-700 pt-8">
                        <p className="text-center text-gray-400">&copy; {new Date().getFullYear()} Eklavya Foundation. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
